...
public class ScheduledSecondSharedViewModel extends ViewModel {
    ...
    public ScheduledSecondSharedViewModel(){
   ...
   /*     List<Boolean> weekDayList = new ArrayList<>();
        weekDay.setValue(weekDayList);*/ // DAO METHODS????
    }
